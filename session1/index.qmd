...
*But these are for a future workshops.* 
...
::: {.smaller}
Similar tools are available in other language, and quarto can contain code chunks of various languages, possibly in the same document.
:::

# Getting started 

## First step {background-color="#006DAE"}
...
## Your turn! {background-color="#006DAE"}
